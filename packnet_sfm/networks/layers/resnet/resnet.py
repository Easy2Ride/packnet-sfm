...
__all__ = ['BasicBlock', 'Bottleneck', 'ResNet', 'resnet18', 'resnet34', 'resnet50', 
           'resnet101', 'resnet152', 'resnext50_32x4d', 'resnext101_32x8d',
           'wide_resnet50_2', 'wide_resnet101_2', 'resnet18_ssl', 'resnet50_ssl',
           'resnext50_32x4d_ssl', 'resnext101_32x4d_ssl', 'resnext101_32x8d_ssl', 
           'resnext101_32x16d_ssl', 'resnet18_swsl', 'resnet50_swsl', 'resnext50_32x4d_swsl', 
           'resnext101_32x4d_swsl', 'resnext101_32x8d_swsl', 'resnext101_32x16d_swsl']
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(load_model_url(arch),
                                              progress=progress)
...
def resnet18_ssl(pretrained=True, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr.
    """
    return _resnet('resnet18_ssl', BasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs)


def resnet50_ssl(pretrained=True, progress=True, **kwargs):
    """Constructs a semi-supervised ResNet-50 model pre-trained on YFCC100M dataset and finetuned on ImageNet 
    `"Billion-scale Semi-Supervised Learning for Image Classification" <https://arxiv.org/abs/1905.00546>`_
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50_ssl', Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)


def resnext50_32x4d_ssl(pretrained=True, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _resnet('resnext50_32x4d_ssl', Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)


def resnext101_32x4d_ssl(pretrained=True, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _resnet('resnext101_32x4d_ssl', Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)


def resnext101_32x8d_ssl(pretrained=True, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 8
    return _resnet('resnext101_32x8d_ssl', Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)


def resnext101_32x16d_ssl(pretrained=True, progress=True, **kwargs):
    ...
    return _resnet('resnext101_32x16d_ssl', Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)


# -------------- semi-weakly supervised models ----------------
def resnet18_swsl(pretrained=True, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr.
    """
    return _resnet('resnet18_swsl', BasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs)


def resnet50_swsl(pretrained=True, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50_swsl',  Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)


def resnext50_32x4d_swsl(pretrained=True, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _resnet('resnext50_32x4d_swsl', Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)


def resnext101_32x4d_swsl(pretrained=True, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _resnet('resnext101_32x4d_swsl', Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)


def resnext101_32x8d_swsl(pretrained=True, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 8
    return _resnet('resnext101_32x8d_swsl', Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)


def resnext101_32x16d_swsl(pretrained=True, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 16
    return _resnet('resnext101_32x16d_swsl', Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
